...
describe('App', () => {
  ...
  beforeEach(() => {
    ...
    const inputComponent = TestUtils.findRenderedDOMComponentWithClass(app, 'main__new-todo-container__input');
    input = ReactDOM.findDOMNode(inputComponent);

    const formComponent = TestUtils.findRenderedDOMComponentWithTag(app, 'form');
